...
def store_folder(dataset_name, network, batch_size, optimizer, learning_rate, available_nets, pretrained=True):
    ...
    model_save_dir = model_save_dir + "_" + dataset_name + "_" + str(batch_size) + "_" + optimizer + "_" + str(learning_rate)
    if pretrained == False:
